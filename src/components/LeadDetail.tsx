...
export default function LeadDetail({ lead, onClose }: LeadDetailProps) {
  ...
  return (
    <div className="w-96 bg-white border-l border-gray-200 flex flex-col h-screen shadow-xl z-10">
      ...
      {/* Action Footer (Removed Generation button because it's in the AI Panel now) */}
      <div className="p-6 bg-gray-50 border-t border-gray-200">
        {!draft && !isGenerating && (
          <p className="text-sm text-gray-500 text-center italic">Use AI Intelligence to draft a response.</p>
        )}
